...
# 📖 React Capstone - CoinGecko <a name="about-project"></a>

This React capstone project is about building a mobile web application to check a list of metrics (numeric values) that I will create making use of React and Redux. It's connected to CoinGecko API to get several data about cryptocurrencies.
...
- [Loom video](https://www.loom.com/share/334c5aca12bc46f48e7bd8a587e0dc19)
...
I would like to thank all Microverse staff and my coding partners as well. Also, I would like to thank for the design idea of Nelson Sawka on [Behance](https://www.behance.net/sakwadesignstudio).
